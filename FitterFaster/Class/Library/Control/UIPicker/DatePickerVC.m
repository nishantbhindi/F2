...
- (id)initWithNibNameAndData:(NSString *)pstrDate withDateFormat:(NSString *)pstrDateFormat withDateDisplayFormat:(NSString *)pstrDateDisplayFormat withID:(id)pId withPickerOptionID:(int)pPickerOptionId withButtonTag:(int)pintTag
{
