...
-(void)initializeAppData{
    ...
    //Configure Instagram AppID
    self.instagram = [[Instagram alloc] initWithClientId:APP_ID_INSTAGRAM delegate:nil];
...
-(void)checkDeviceCompatibility{
    ...
    _landingViewController = [[[LandingViewController alloc] initWithNibName:@"LandingViewController" bundle:nil] autorelease];
    ...
    */
    ...
    ////Add Landing Page////
    UINavigationController *nc = [[UINavigationController alloc] initWithRootViewController:_landingViewController];    //_viewController
